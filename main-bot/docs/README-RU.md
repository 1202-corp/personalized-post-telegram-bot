...
Основной бот обрабатывает взаимодействие с пользователями, флоу обучения и доставку персонализированной ленты. Использует паттерн registry для управления различными типами сообщений (системные, временные, одноразовые).
